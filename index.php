...
<head>
    <title>Ngong Uphill's Rentals Website</title>
    <meta charset="utf-8">
                    ...
                    <div class="room-wrap d-md-flex">
                        ...
                        <div class="half left-arrow d-flex align-items-center">
                            <div class="text p-4 p-xl-5 text-center">
                                ...
                                <p class="pt-1"><a href="room-single.php" class="btn-custom px-3 py-2">View Room
                        ...
                        <div class="half left-arrow d-flex align-items-center">
                            <div class="text p-4 p-xl-5 text-center">
                                <p class="star mb-0"><span class="fa fa-star"></span><span
                                        ...
                                        class="fa fa-star"></span><span class="fa fa-star"></span></p>
                                <!-- <p class="mb-0"><span class="price mr-1">$120.00</span> <span class="per">per night</span></p> -->
                                <h3 class="mb-3"><a href="rooms.php">Standard Room</a></h3>
                                <ul class="list-accomodation">
                                    <li><span>Max:</span> 3 Persons</li>
                                    <li><span>Size:</span> 45 m2</li>
                                    <li><span>View:</span> Sea View</li>
        ...
        <div class="container">
            <div class="row no-gutters">
                <div class="col-md-6 wrap-about">
                    ...
                    <h2>The most recommended Ngong Uphill's Rentals </h2>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-8">
                        ...
                        <p class="copyright mb-0">
                            ...
                            </script> All rights reserved |Need a webstie like this reach to us <a href="#">ePledge
                                Inc</a>
                            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </p>
                    </div>
