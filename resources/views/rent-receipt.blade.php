                            ...
                            <div class="card">
                                ...
                                <div class="dull-bg from-to m-1">
                                    <div class="d-flex flex-row bd-highlight mb-3">
                                        <div class="col-sm-6 col-md-5 col-lg-6">
                                            <h5>To </h5>
                                            <p>{{ $latestPayment->name }}</p>
                                            <p>{{ $latestPayment->house_no }}</p>
                                            <p>{{ $latestPayment->category }}</p>
                                        </div>
                                        <div class="col-sm-6 col-md-5 offset-md-2 col-lg-6 offset-lg-0 ">
                                            <table class="short-info w-95">
                                                <tr>
                                                    <td>Invoice No: </td>
                                                    <td class="float-end"><span>{{ $latestPayment->invoice }}</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Invoice Date:</td>
                                                    <td class="float-end">
                                                        <span>{{ $latestPayment->created_at }}</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Due:</td>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="total-price">
                                                                    <h6><span>{{ $latestPayment->amount }}</span></h6>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                            ...
                                                            <tr class="total-amount">
                                                                <td>
                                                                    <h6>Amount due on {{ $latestPayment->created_at }}:
                                                                    </h6>
                                                                </td>
                                                                <td class="total-price">
                                ...
                                <div class="payment-detail d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <p class="mt-4">Please use as {{ $latestPayment->invoice }} as a reference
                                            number</p>
