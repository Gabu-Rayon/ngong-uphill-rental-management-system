  ...
  <body>
   ...
   <main>
    ...
    <footer class="footer">
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-lg-3 mb-md-0 mb-4">
						...
						<p>We are  most trusted in real Estate,exomplary tenants services offered,well maintained estates and Storey rentals and more.Want to learn more and join us in your stay.</p>
	  ...
	  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This Website is made with  by <a href="#" target="_blank">ePledge Inc.</a>
